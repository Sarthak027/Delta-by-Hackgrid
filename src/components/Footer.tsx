...
import { Twitter, Github, Linkedin, Mail, Triangle } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-gray-400 -mt-1">by Hackgrid</span>
              </div>
            </div>
            <p className="text-gray-400 mb-6 max-w-md">
              The easiest way to create stunning portfolio websites without coding. 
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2025 Hackgrid. All rights reserved.
          </p>
